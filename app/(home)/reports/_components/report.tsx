            ...
            <div className="flex gap-3">
              <button
               onClick={() => exportToWord(data, "reports.docx")}
                className="flex items-center gap-2 px-4 py-2 text-blue-600 rounded-lg text-sm font-medium transition-colors border border-blue-600"
              >
                <Download size={16} />
                <span>Word</span>
              </button>
              <button
                ...
                className="flex items-center gap-2 px-4 py-2  text-green-600 rounded-lg text-sm font-medium transition-colors border border-green-600"
              >
                <Download size={16} />
                <span>Excel</span>
              </button>
