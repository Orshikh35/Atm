            ...
            <table>
              <tr>
                <td class="left">
                  ...
                  <div class="field"><span class="label">Хүсэлт илгээсэн огноо:</span> ${r.requestDate}</div>
                  <div class="field"><span class="label">Хаагдсан огноо:</span> ${r.closureDate || "Хаагдаагүй"}</div>
                </td>
                <td class="right">
